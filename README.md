...
- ***Tệp thực thi:*** Tệp ```chrome.exe (trên Windows)``` là tệp thực thi của ```Google Chrome```. Khi bạn nhấp vào biểu tượng ```Google Chrome```, hệ điều hành sẽ gọi tệp này và chương trình bắt đầu chạy.
